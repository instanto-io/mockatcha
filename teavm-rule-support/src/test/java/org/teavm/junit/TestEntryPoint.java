...
final class TestEntryPoint {
    ...
    /**
     * Wraps the statement in the test case's rules, outermost rule last.
     *
     * <p>Generated by the transformer, which knows the test class and so can read its rule fields
     * without reflection. Returns the statement unchanged when the test class declares no rules.
     */
